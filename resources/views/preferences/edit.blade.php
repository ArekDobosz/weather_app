	...
	<div class="panel-body">
		<form action="{{ url('preferences/'. $user->token) }}" method="POST" novalidate="">
			...
			<div class="form-group col-md-4 {{ $errors->has('max_temp') ? 'has-error' : '' }}">
				...
				<input type="number" name="max_temp" min="-50" max="50" step="3" value="{{ $user->max_temp ?? old('max_temp') }}" class="form-control">
			...
			<div class="form-group col-md-4 {{ $errors->has('min_temp') ? 'has-error' : '' }}">
				...
				<input type="number" name="min_temp" min="-50" max="50" step="3" value="{{ $user->min_temp ?? old('min_temp') }}" class="form-control">
				<div class="help-block">
			...
			<div class="form-group col-md-4 {{ $errors->has('radiation') ? 'has-error' : '' }}">
				...
				<input type="number" name="radiation" min="0" max="11" step="1" value="{{ $user->radiation ?? old('radiation') }}" class="form-control">
				<div class="help-block">
			...
			<div class="form-group col-md-4 {{ $errors->has('max_humidity') ? 'has-error' : '' }}">
				...
				<input type="number" name="max_humidity" min="0" max="100" step="5" value="{{ $user->max_humidity ?? old('max_humidity') }}" class="form-control">
				<div class="help-block">
			...
			<div class="form-group col-md-4 {{ $errors->has('min_humidity') ? 'has-error' : '' }}">
				...
				<input type="number" name="min_humidity" min="0" max="100" step="5" value="{{ $user->min_humidity ?? old('min_humidity') }}" class="form-control">
				<div class="help-block">
			...
			<div class="form-group col-md-4 {{ $errors->has('wind') ? 'has-error' : '' }}">
				...
				<input type="number" name="wind" min="0" max="200" step="10" value="{{ $user->wind ?? old('wind') }}" class="form-control">
				<div class="help-block">
					@if($errors->has('wind'))
                        {{ $errors->first('wind') }}
                    @endif
